...
void GameManage::endTouch()
{
	...
	if (fillvec.empty())
	{
		...
		box->runAction(Sequence::create(MoveTo::create(0.1f, box->getCenterAnPointX(Vec2(nextboxbegin + nextboxoffest*(_touchselect - 1), selectboxoffest))), CallFunc::create([this]() {
			_touchselect = 0;
			setTouchState(TOUCH_TRUE);
		}), nullptr));
	...
	else
	{
		...
		box->runAction(Sequence::create(MoveTo::create(0.01f, positionByPos(fillvec[0])), CallFunc::create([this, box, fillvec]() {
